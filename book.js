...
async function main() {
  ...
  const cubeVAO = twgl.createVAOFromBufferInfo(gl, programInfo, parts);
  ...
  window.addEventListener(
    "wheel",
    (e) => (cameraPosition[2] += e.deltaY * 0.005)
  );
  ...
  function drawScene(time) {
    ...
    // cameraMatrix = m4.translate(-1)
    // cameraMatrix = m4.xRotate(cameraMatrix, degToRad(10))
    // cameraMatrix = m4.yRotate(cameraMatrix, degToRad(25))
